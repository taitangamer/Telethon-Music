...
async def start(event):
    ...
    if event.is_private:
       await event.client.send_file(event.chat_id,
        ...
        [Button.url("🗣️ ꜱᴜᴘᴘᴏʀᴛ", f"https://t.me/Dangerous_fighter_clan_1"), Button.url("📣 ᴜᴘᴅᴀᴛᴇꜱ", f"https://t.me/{Config.CHANNEL}")],
...
async def _(event):
    ...
    if event.is_private:
       await event.edit(PM_START_TEXT.format(event.sender.first_name), buttons=[
        [Button.url("➕ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ᴄʜᴀᴛ", f"https://t.me/{BOT_USERNAME}?startgroup=true")],
        [Button.url("👨‍💻 ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", "https://github.com/ITZ-ZAID/Telethon-Music")],
        [Button.url("🗣️ ꜱᴜᴘᴘᴏʀᴛ", f"https://t.me/Dangerous_fighter_clan_1"), Button.url("📣 ᴜᴘᴅᴀᴛᴇꜱ", f"https://t.me/Dangerous_fighter_clan_1")],
        [Button.inline("ʜᴇʟᴘ ᴀɴᴅ ᴄᴏᴍᴍᴀɴᴅꜱ", data="help")]])
       return
